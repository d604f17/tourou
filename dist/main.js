...
var _RouteCollection = __webpack_require__(4);
...
var waypoints = [new _Waypoint2.default(56, 10, 0), new _Waypoint2.default(56.1, 10, 2), new _Waypoint2.default(56, 10.1, 3), new _Waypoint2.default(56.1, 10.1, 4)];

var route1 = new _Route2.default(waypoints[0], waypoints[1]);
route1.addWaypoint(waypoints[2]);
route1.addWaypoint(waypoints[3]);

console.log(route1.getHashCode());

var route2 = new _Route2.default(waypoints[0], waypoints[2]);
route2.addWaypoint(waypoints[1]);
route2.addWaypoint(waypoints[3]);

console.log(route2.getHashCode());

var routes = new _RouteCollection2.default([route1]);
