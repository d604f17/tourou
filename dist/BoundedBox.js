...
var BoundedBox = function () {
  ...
  _createClass(BoundedBox, [{
    ...
    key: 'area',
    get: function get() {
      var verticalA = { longitude: this.e, latitude: this.n };
      var verticalB = { longitude: this.e, latitude: this.s };
      var horizontalA = { longitude: this.e, latitude: this.n };
      var horizontalB = { longitude: this.w, latitude: this.n };
