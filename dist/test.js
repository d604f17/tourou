...
var theHalfeningTest = function theHalfeningTest(city, waypoints, passes, iterations) {
  ...
  for (var i = 1; i <= passes; i++) {
    queries.push(test('ant-half_' + city + '_i' + iterations + '_p' + i, function (resolve) {
      var start = new Date().getTime();
      (0, _halfnhalf2.default)(iterations, 20000, waypoints).then(function (route) {
        var end = new Date().getTime();
...
var tests = [].concat(_toConsumableArray(theHalfeningTest('compare-barcelona_m20k', attractions.barcelona, 5, 3)), _toConsumableArray(diagonalizationTest('compare-barcelona_m20k', attractions.barcelona, 5, 30)), _toConsumableArray(theHalfeningTest('compare-berlin_m20k', attractions.berlin, 5, 3)), _toConsumableArray(diagonalizationTest('compare-berlin_m20k', attractions.berlin, 5, 45)), _toConsumableArray(theHalfeningTest('compare-rio_m20k', attractions.rio, 5, 5)), _toConsumableArray(diagonalizationTest('compare-rio_m20k', attractions.rio, 5, 86)), _toConsumableArray(theHalfeningTest('compare-rome_m20k', attractions.rome, 5, 5)), _toConsumableArray(diagonalizationTest('compare-rome_m20k', attractions.rome, 5, 93)));
